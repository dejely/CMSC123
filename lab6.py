...
class DLLPriorityQueue:
	...
	def __init__(self):
		...
		# constructor: set properties head_guard, tail_guard, size
		# link head_guard and tail_guard to each other using set_next() and set_prev()
		self.size = 0
	...
	def __repr__(self):
		# NOTE: DO NOT EDIT THIS CODE
		# string representation of DLLPriorityQueue object
		display = []
